...
// in marvel_project/test/features/characters/external/marvel_api_characters_datasource_test.dart.
...
class MockHttpClient extends _i1.Mock implements _i2.HttpClient {
  ...
  @override
  _i3.Future<dynamic> post(String? url, Map<String, dynamic>? data) =>
      (super.noSuchMethod(Invocation.method(#post, [url, data]),
          returnValue: Future<dynamic>.value()) as _i3.Future<dynamic>);
  @override
